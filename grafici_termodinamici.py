...
def isoentropiche():
    ...
    P=np.linspace(20,P_max,len_p)*100000
    H=np.zeros(len_p)
...
def isoterme():
    ...
    for i in range (1,len(T2)):
        ...
        if i% 2 == 0:
            plt.text(H[0]/1000,P[0]/100000-2, str(int(T2[i]-273.15)), fontdict=font)
            #plt.annotate(str(int(T2[i]-273.15)),xy=(H[0]/1000,P[0]/100000),facecolor='black')
    ...
    plt.plot(H/1000,P/100000,'g',linewidth=0.5)
    plt.text(H[0]/1000,P[0]/100000-2, str(int(T_crit-273.15)), fontdict=font)
    ...
    for i in range (1,len(T1)):
        ...
        if i% 2 == 0:
            plt.text(H[0]/1000,P[0]/100000-2, str(int(T1[i]-273.15)), fontdict=font)
